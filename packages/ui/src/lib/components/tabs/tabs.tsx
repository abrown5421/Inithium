...
const tabSelectedStyles = (variant: TabsVariant, color: ThemeColor, vertical: boolean): string => {
  const variantColorMaps: Record<TabsVariant, Record<ThemeColor, string>> = {
    ...
    enclosed: {
      primary: 'bg-white border border-slate-200 text-primary shadow-xs rounded-lg',
      secondary: 'bg-white border border-slate-200 text-secondary shadow-xs rounded-lg',
      accent: 'bg-white border border-slate-200 text-accent shadow-xs rounded-lg',
      success: 'bg-white border border-slate-200 text-success shadow-xs rounded-lg',
      warning: 'bg-white border border-slate-200 text-warning shadow-xs rounded-lg',
      danger: 'bg-white border border-slate-200 text-danger shadow-xs rounded-lg',
      surface: 'bg-white border border-slate-200 text-surface shadow-xs rounded-lg',
      surface2: 'bg-white border border-slate-200 text-surface2 shadow-xs rounded-lg',
      surface3: 'bg-white border border-slate-200 text-surface3 shadow-xs rounded-lg',
      surface4: 'bg-white border border-slate-200 text-surface4 shadow-xs rounded-lg',
      'primary-contrast': 'bg-white border border-slate-200 text-primary-contrast shadow-xs rounded-lg',
      'secondary-contrast': 'bg-white border border-slate-200 text-secondary-contrast shadow-xs rounded-lg',
      'accent-contrast': 'bg-white border border-slate-200 text-accent-contrast shadow-xs rounded-lg',
      'success-contrast': 'bg-white border border-slate-200 text-success-contrast shadow-xs rounded-lg',
      'warning-contrast': 'bg-white border border-slate-200 text-warning-contrast shadow-xs rounded-lg',
      'danger-contrast': 'bg-white border border-slate-200 text-danger-contrast shadow-xs rounded-lg',
      'surface-contrast': 'bg-white border border-slate-200 text-surface-contrast shadow-xs rounded-lg',
      'surface2-contrast': 'bg-white border border-slate-200 text-surface2-contrast shadow-xs rounded-lg',
      'surface3-contrast': 'bg-white border border-slate-200 text-surface3-contrast shadow-xs rounded-lg',
      'surface4-contrast': 'bg-white border border-slate-200 text-surface4-contrast shadow-xs rounded-lg',
    },
  };
